      ...
      <ul class="nav side-menu">
        <li><a><i class="fa fa-home"></i> Karyawan <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <li><a href="{{url('/addkaryawan')}}">Tambah</a></li>
            <li><a href="{{url('/datakaryawan')}}">Data Karyawan</a></li>
          </ul>
        </li>
        <li><a><i class="fa fa-home"></i> Absensi <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <li><a href="{{url('/absensilog')}}">Log</a></li>
          </ul>
        </li>
        <li><a><i class="fa fa-home"></i> QrCode Absen <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <li><a href="{{url('/qrcodelog')}}">Form Absen</a></li>
          </ul>
        </li> 
      </ul>
    </div>
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        <li><a><i class="fa fa-bug"></i> Laporan <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <li><a href="#">Laporan Pegawai</a></li>
          </ul>
        </li>
      </ul>
    </div>
